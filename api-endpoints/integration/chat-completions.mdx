...
This parameter allows you to control how you can override the parameters in the prompt.
  <AccordionGroup >
    <Accordion title="Properties">
        <ParamField path="messages_override_mode" type="string">
...
<ParamField name="retry_params" type="object">
  ...
  <Accordion title="Properties">
    <ParamField name="retry_enabled" type="boolean" required>
        Enable or disable retries.
    </ParamField>
    <ParamField name="num_retries" type="number">
        The number of retries to attempt.
    </ParamField>
    <ParamField name="retry_after" type="number">
...
<ParamField name="customer_params" type="object">
