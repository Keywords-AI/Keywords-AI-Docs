...
<ParamField path="prompt_messages" type="array" required>
...
<Accordion>
  ...
  <ParamField path="function" type="dict">
  </ParamField>

  <Accordion>
    <ParamField path="name" type="string">
    </ParamField>
    <ParamField path="arguements" type="string">
    </ParamField>
...
<ParamField path="customer_params" type="string">
...
Usage details for the LLM inference. Currently, only support Prompt Caching.
  <AccordionGroup>
    <Accordion title="Properties">
      <ParamField path="prompt_tokens_details" type="object">

      <Accordion title="Properties">
        <ParamField path="cached_tokens" type="integer">
        Number of tokens in the prompt.
        </ParamField>
      </Accordion>
      </ParamField>
      <ParamField path="cache_creation_prompt_tokens" type="integer">
...
{/* <ParamField path="cached_response" type="integer">
