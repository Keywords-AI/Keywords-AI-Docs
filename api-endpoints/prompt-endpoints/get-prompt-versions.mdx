...
api: "GET https://api.keywordsai.co/prompts/<prompt_id>/versions/"
---
...
url = "https://api.keywordsai.co/prompts/<prompt_id>/versions/"
...
fetch('https://api.keywordsai.co/prompts/<prompt_id>/versions/', 
{
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
...
You can get a single prompt version by sending a GET request to the `/prompts/<prompt_id>/versions/<version_id>/` endpoint.
