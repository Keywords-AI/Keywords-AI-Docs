...
- [Custom Workflow Guide](/documentation/products/evaluation/experiments/workflows/custom-workflow) - Submit your own results
- [Completion Workflow Guide](/documentation/products/evaluation/experiments/workflows/completion-workflow) - Direct LLM completions
- [Prompt Workflow Guide](/documentation/products/evaluation/experiments/workflows/prompt-workflow) - Use prompt templates
