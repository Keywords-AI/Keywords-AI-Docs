...
api: POST https://api.keywordsai.co/v1/traces/ingest
---
...
<Tip>Example project: [Github Link](https://github.com/Keywords-AI/keywordsai-example-projects/tree/main/example_scripts/python/logs_to_trace)</Tip>
