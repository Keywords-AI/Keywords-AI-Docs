...
See the [Create Log](/api-endpoints/observe/logs/request-logging-endpoint) documentation for complete field specifications and [log types](https://localhost:3001/get-started/observability_data_model#log-types) for `log_type` details.
</ParamField>
