...
The system automatically extracts type-specific fields based on the `log_type`. See [log types](https://localhost:3001/get-started/observability_data_model#log-types) for complete specifications and the [Create Log documentation](/api-endpoints/observe/logs/request-logging-endpoint) for all field details.
