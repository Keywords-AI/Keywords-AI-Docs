...
api: "GET /api/payment/credit-transactions/"
description: "Returns all credit transactions for your organization, newest first"
---

Returns all credit transactions for your organization with complete audit trail history.
...
```bash cURL
curl -X GET "https://api.keywordsai.co/api/payment/credit-transactions/" \
