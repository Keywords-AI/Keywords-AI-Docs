...
api: "GET /api/payment/credit-transactions/{id}/"
description: "Retrieves a single credit transaction by ID"
---

Retrieves detailed information about a specific credit transaction.
...
url = f"https://api.keywordsai.co/api/payment/credit-transactions/{transaction_id}/"
headers = {
...
const url = `https://api.keywordsai.co/api/payment/credit-transactions/${transactionId}/`;
const headers = {
    'Authorization': 'Bearer YOUR_API_KEY'
};
...
```bash cURL
curl -X GET "https://api.keywordsai.co/api/payment/credit-transactions/ct_1a2b3c4d5e6f7g8h/" \
