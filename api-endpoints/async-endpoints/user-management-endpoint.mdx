...
User management endpoint allows you to update user information, and set budgets and limits for a specific user.
...
base_url = "https://api.keywordsai.co/api/user/update/<str:customer_identifier>"
