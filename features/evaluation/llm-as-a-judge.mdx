...
Configure the evaluator with the prompt and the customer you want to evaluate. You can also test the evaluator with a sample prompt. You should also define what metrics are required for the evaluator.
...
```json
{
  ...
  "evaluation_params": { 
    ...
    "extra_params": {
        "retrieved_contexts": ["the capital of France is Paris", "France is a country in Europe"], //you should define this parameter in UI
        "expected_response": "Paris" //you should define this parameter in UI
    },
