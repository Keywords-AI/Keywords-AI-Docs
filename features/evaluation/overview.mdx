...
Keywords AI integrates with [Ragas](https://docs.ragas.io/en/stable/getstarted/index.html), an open-source package created for granular and holistic evaluation of GenAI application pipelines, to provide a comprehensive evaluation of the LLM-generated results from the Keywords AI API.
