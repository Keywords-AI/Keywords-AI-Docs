...
## Next step
<CardGroup cols={2}>
<Card title="Log a prompt"  href="../prompt/prompt-management/monitor-a-prompt">
</Card>
<Card title="Deploy a prompt"  href="../prompt/prompt-management/deploy-a-prompt">
    </Card>
    <Card title="Monitor a prompt"  href="../prompt/prompt-management/monitor-a-prompt">
