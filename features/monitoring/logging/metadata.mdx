...
After sending custom properties in your code, you can filter dashboard metrics using these properties. Simply click the `Filter` button and select the relevant `Custom properties` to narrow down your data visualization.
