...
description: The best LLM dashboard to monitor your API usage and spending.
...
You could monitor your organization's: 
- API usage and spending  (see how to manage your API keys [here](/features/generation/key-management))
- Top users (see how to tag your users [here](/features/monitoring/user-data#example))
- Top models

<img src="/images/platform-features/dashboard/organization.png" />
