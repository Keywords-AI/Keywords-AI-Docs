...
You can turn on/off the safety net _[here](https://platform.keywordsai.co/platform/api/alerts-&-fallback)_.
...
- You uploaded some invalid [`customer_credentials`](/api-endpoints/proxy-endpoints/chat-completions#keywords-ai-parameters)
