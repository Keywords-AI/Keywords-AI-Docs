---
title: Dashboard
description: A guide to customize your metrics dashboard in Keywords AI for complete LLM application observability.
---

## What is the usage dashboard?
The usage dashboard is a comprehensive dashboard that provides a detailed overview of your LLM usage and spending. It allows you to monitor your LLM usage and spending in real-time, and to customize the metrics and breakdowns to suit your needs.

## It's useful for you if:
- You want to monitor your LLM usage and spending in real-time
- You want to customize the metrics and breakdowns to suit your needs
- You want to understand your users and their behavior on your LLM applications
- You want to track each prompt's performance
