...
If all your fallback models also fail, Keywords AI will continue to catch the error if you have [safety net](/platform-features/alerts-and-fallback) enabled.
