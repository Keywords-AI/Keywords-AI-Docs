...
<ParamField path="customer_credentials" type="dict">
You can pass in a dictionary of your customer's credentials and deployment variables for [supported providers](/integration/llm-credits) and use their credits when the router is calling models from those providers.
