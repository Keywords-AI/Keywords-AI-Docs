...
<ParamField path="temperature" type="float" default={1}>
  ...
  a more random response. See more info in the [LLM parameters
  page](/get-started/llm-params)
</ParamField>
...
Adding this returns the evaluation metrics in the response body. If streaming is on, the metrics will be streamed as the last chunk
