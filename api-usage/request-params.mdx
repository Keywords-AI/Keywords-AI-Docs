...
<ParamField path="tool_choice" type="dict">
  Manually picking the choice of tool for the model to use. This will force the model to make a function call everytime a function is passed in.
  ```json
  {
    "type": "function",
...
<ParamField path="customer_identifier" type="string">
  Use this the as a tag to identify the user associated with the API call.
</ParamField>
