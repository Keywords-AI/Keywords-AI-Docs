...
<AccordionGroup>
  ...
  <Accordion title="Keywords AI Parameters">
    Use these when you want to achieve specific goals. For example, you can use `fallback_models` to specify fallback models when the primary model is down. You can check out all [Keywords AI parameters in this page](/api-endpoints/integration/chat-completions#keywords-ai-parameters).
  </Accordion>
</AccordionGroup>
