...
## Next steps
<CardGroup cols={2}>
<Card title="Deploy the prompt to code" href="/features/prompt/deploy-a-prompt">
</Card>
<Card title="Monitor prompts" href="/features/prompt/monitor-a-prompt">
</Card>
<Card title="Collaborate with your team" href="/features/prompt/share-a-prompt">
</Card>
<Card title="Evaluate your prompt" href="/features/prompt/lab">
</Card>
</CardGroup>
