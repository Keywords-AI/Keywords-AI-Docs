...
<CardGroup cols={2}>
<Card title="Switch to a different model" href="/guides/switch-model">
</Card>
<Card title="Reliability settings" href="/guides/more-reliability">
</Card>
<Card title="Set up observability" href="/guides/observability">
</Card>
