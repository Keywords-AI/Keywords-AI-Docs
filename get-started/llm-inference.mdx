---
title: "Begin with LLM proxy"
description: "Keywords AI LLM proxy supports you call 250+ LLMs using the same input/output format."
---

## What is an LLM proxy?
An LLM proxy is a simple “middleman” between you and Large Language Models (LLMs). It handles things like:
...
## How to use Keywords AI LLM proxy
...
### 2. Integrate LLM proxy into your codebase
...
If you are using OpenAI SDK, it's pretty straightforward to integrate LLM proxy into your codebase.
...
### 3. Add your credentials to activate LLM proxy
For all LLM proxy users, you have to add your own credentials to activate LLM proxy. We will use your credentials to call LLMs on your behalf. For example, if you want to use OpenAI, you have to add your OpenAI API key to activate LLM proxy.
...
<CardGroup cols={2}>
<Card title="Switch to a different model" href="/features/generation/gateway">
</Card>
<Card title="Reliability settings" href="/features/generation/fallbacks">
</Card>
<Card title="Set up observability" href="/get-started/async-logging">
</Card>
<Card title="Prompt engineering" href="/features/prompt/create-a-prompt">
</Card>
</CardGroup>