...
Unfortunately, the API key will only show once after you generate it. If you have lost your API key, you will have to regenerate your [API Keys](https://platform.keywordsai.co/platform/api/api-keys) on the platform.