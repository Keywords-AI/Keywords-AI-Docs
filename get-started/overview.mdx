...
- **LLM inference**: Use our unified LLM API to build, monitor, and enhance your LLM applications with just 2 lines of code.
  - Unlock additional features like fallbacks, load balancing, metadata, and API key management.
  - Leverage 200+ best-in-class models from OpenAI, Anthropic, Google, and more.
- **Aysnc Logging**: Use our async logging API to monitor your custom model.
  - Zero impact on application latency. (Critical for voice AI)
...
## LLM monitoring
<CardGroup cols={2}>
  <Card title="LLM dashboard" icon="link" href="/features/monitoring/analytics">
    A graphical view for monitoring your usage, performance, and cost.
  </Card>
  <Card title="Logs" icon="link" href="/features/monitoring/logging">
...
<CardGroup cols={2}>
  ...
  <Card title="Metadata" icon="link" href="/features/generation/metadata">
    Pass extra parameters to your LLM requests 
  </Card>
  <Card title="API keys management" icon="link" href="/features/generation/key-management">
