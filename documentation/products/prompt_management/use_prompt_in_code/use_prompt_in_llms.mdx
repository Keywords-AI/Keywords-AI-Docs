...
Users can now specify a version of prompt they want to call. This prompt version does not need to be deployed and therefore this feature is very nice for testing a prompt through the gateway.
```python {4}
{
    "prompt": {
