...
description: This is a guide for you to set up an online evaluation on the platform. 
---

## What is an online evaluation? 
Online evaluation automatically runs evaluators on your production logs in real-time based on conditions and sampling rules.

## How to set up an online evaluation?

### 1. Create a condition

A **condition** defines the filtering rules that determine which production logs will be evaluated—only logs that match the condition proceed to the sampling and evaluation stages.  
...
We will choose **Single log** for **Online evaluation**.  
...
### 2. Create an online evaluation

Once your condition and evaluator are ready, navigate to [Automations](https://platform.keywordsai.co/platform/monitors) and create a new **automation**.
...
1. Select **Online evaluation** as the type.
...
After saving, your online evaluation will appear in the [Automations](https://platform.keywordsai.co/platform/monitors) list.  
