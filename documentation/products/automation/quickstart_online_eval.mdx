---
title: Online eval
description: This is a guide for you to set up an online eval on the platform. 
---

## What is an online eval? 
Online eval automatically runs evaluators on your production logs in real-time based on conditions and sampling rules.

## How to set up an online eval?

### 1. Create a condition

A **condition** defines the filtering rules that determine which production logs will be evaluated—only logs that match the condition proceed to the sampling and eval stages.  
...
We will choose **Single log** for **Online eval**.  
...
1. Select **Online eval** as the type.
...
After saving, your online eval will appear in the [Automations](https://platform.keywordsai.co/platform/monitors) list.  
