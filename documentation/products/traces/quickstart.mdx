...
<Card href="/integration/development-frameworks/tracing/openai-agents-sdk">
    <img src="https://keywordsai-static.s3.us-east-1.amazonaws.com/docs/Integrations/integration_cards/openai_agent_v0.png" alt="OpenAI Agent SDK" style={{
      pointerEvents: 'none'
    }} />
</Card>
...
<Card href="/integration/development-frameworks/tracing//mastra">
    <img src="https://keywordsai-static.s3.us-east-1.amazonaws.com/docs/Integrations/integration_cards/mastra_v0.png" alt="Mastra SDK" style={{
      pointerEvents: 'none'
    }} />
</Card>
<Card href="#keywords-ai-native-tracing">
    <img src="https://keywordsai-static.s3.us-east-1.amazonaws.com/docs/Integrations/integration_cards/keywordsai_v0.png" alt="Keywords AI Native" style={{
      pointerEvents: 'none'
    }} />
</Card>
</CardGroup>
