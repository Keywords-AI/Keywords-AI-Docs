---
title: "Pass Keywords AI params to your traces"
...
For the complete list of available parameters, see the [Keywords AI API reference](https://docs.keywordsai.co/api-endpoints/integration/request-logging-endpoint).
