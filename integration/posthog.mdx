...
Go to [PostHog](https://posthog.com/) and create an account. Go to PostHog's [API/Capture](https://posthog.com/docs/api/capture) page in their documentation and get your PostHog API key and base URL.
</Step>
...
You can use the official Keywords AI template in PostHog (coming soon) to create a dashboard to monitor your LLM performance.
