...
description: "Use Google GenAI SDK with Keywords AI"
---

## What is Google GenAI SDK?

Keywords AI is compatible with the official Google GenAI SDK, enabling you to use Google's Gemini models through our gateway with full observability, monitoring, and advanced features.
...
<Steps>
<Step title="Step 1: Install the SDK">
Install the official Google GenAI SDK for TypeScript.
