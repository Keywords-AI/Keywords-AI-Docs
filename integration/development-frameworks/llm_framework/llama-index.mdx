...
We support all the [OpenAI parameters](/api-endpoints/integration/chat-completions#openai-parameters). You can pass them directly in the LlamaIndex configuration.
...
[Keywords AI parameters](/api-endpoints/integration/chat-completions#keywords-ai-parameters) can be passed using `extra_body` for better handling and customization.
...
<CardGroup cols={2}>
<Card title="Advanced settings" href="/features/monitoring/user-analytics">
  Track user behavior and patterns
</Card>
<Card title="Prompt Management" href="/features/prompt/prompt-management/overview">
