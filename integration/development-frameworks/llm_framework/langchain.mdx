...
We support all the [OpenAI parameters](/api-endpoints/develop/gateway/chat-completions#openai-parameters). You can pass them directly in the LangChain configuration.
