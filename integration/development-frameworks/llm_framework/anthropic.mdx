...
- **Limited Gateway Features**: You can't use features like [user rate limits](/features/governance/rate-limits), [fallbacks](/features/generation/fallbacks) or [load balancing](/features/generation/load-balancing). 
