...
description: "Keywords AI and OpenAI "
---
<Note>This integration is only for Agent tracing. If you are looking for a general integration for OpenAI, please see the [OpenAI integration](/integration/development-frameworks/openai-sdk).</Note>
