...
<Note> This integration is only for **Keywords AI LLM proxy** user. If you only want to log LLM calls and responses, you can use the [Logging API](/api-endpoints/integration/request-logging-endpoint) to log LLM calls. </Note>
