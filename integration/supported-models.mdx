...
description: 'Call 200+ LLMs using the same format'
icon: 'square-list'
---
...
## Integration example
Choose a model from the **[Models Page](https://platform.keywordsai.co/platform/models)**, then add the ``model`` to your payload.
```json
{
...
```
## Support & Pricing
<Tip>Request more models [here](https://discord.com/invite/KEanfAafQQ)</Tip>
We're trying our best to matching providers' pricing timely. You can find the pricing details in the **[Models Page](https://platform.keywordsai.co/platform/models)**
