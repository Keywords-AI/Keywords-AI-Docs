...
<CardGroup cols={1}>
  <Card title="Get Groq API key" icon="key" href="https://console.groq.com/keys">
    Get your Groq API key from the Groq Console to start using Groq models through Keywords AI.
  </Card>
</CardGroup>
...
## Via code
- Add `customer_credentials` parameter in your [request body](/api-endpoints/develop/gateway/chat-completions) to use your own Groq credits.
