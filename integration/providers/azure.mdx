...
<CardGroup cols={1}>
  <Card title="Get Azure OpenAI credentials" icon="key" href="https://portal.azure.com/#view/Microsoft_Azure_ProjectOxford/CognitiveServicesHub/~/OpenAI">
    Get your Azure OpenAI API key, base URL, and API version from the Azure Portal to start using Azure OpenAI models through Keywords AI.
  </Card>
</CardGroup>
...
Add `customer_credentials` parameter in your [request body](/api-endpoints/develop/gateway/chat-completions) to use your own Azure OpenAI credits.
...
You can add more deployments and load balance between them. Learn more about how to do it [here](/documentation/products/gateway/traffic_management/load-balancing).
