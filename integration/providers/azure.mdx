...
We understand that you may have a custom name for your Azure deployment. So if you want to specify a particular model in your Azure deployment, you should map it as `azure/{your deployment name}`.

For example, in Azure OpenAI, you might deployed `gpt-4o` as `gpt-4o` or `gpt-4o-whatever`, so you should map it as `azure/apgt-4o` or `azure/gpt-4o-whatever`.
</Step>
</Steps>
