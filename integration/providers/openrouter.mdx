...
<CardGroup cols={1}>
  <Card title="Get OpenRouter API key" icon="key" href="https://openrouter.ai/keys">
    Get your OpenRouter API key from the OpenRouter platform to start using OpenRouter models through Keywords AI.
  </Card>
</CardGroup>

## OpenRouter models compatibility
...
## Via code
- Add `customer_credentials` parameter in your [request body](/api-endpoints/develop/gateway/chat-completions) to use your own OpenRouter credits.
