...
<CardGroup cols={1}>
  <Card title="Get Fireworks API key" icon="key" href="https://fireworks.ai/api-keys">
    Get your Fireworks API key from the Fireworks platform to start using Fireworks models through Keywords AI.
  </Card>
</CardGroup>

## Fireworks models compatibility
...
<Step title="Add your Fireworks credentials.">
...
## Add it in code
- Add `customer_credentials` parameter in your [request body](/api-endpoints/develop/gateway/chat-completions) to use your own Fireworks credits.
