"""
Example demonstrating the SpanBuffer feature for batch span collection and export.
...
def example_1_basic_usage():
    ...
    with client.get_span_buffer("trace-basic-example") as collector:
...
def example_2_async_span_creation():
    ...
    with client.get_span_buffer("trace-async-example") as collector:
...
def example_3_span_inspection():
    ...
    with client.get_span_buffer("trace-inspection-example") as collector:
        # Create some spans
...
def example_4_isolation():
    ...
    with client.get_span_buffer("trace-isolation-example") as collector:
...
def example_5_multiple_collectors():
    ...
    with client.get_span_buffer("trace-collector-1") as collector1:
    ...
    with client.get_span_buffer("trace-collector-2") as collector2:
