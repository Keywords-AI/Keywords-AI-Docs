...
## What is Keywords AI AI gateway
Keywords AI's AI Gateway is a proxy that lets you interface with 250+ large language models (LLMs) via one unified API. Instead of maintaining separate SDKs or endpoints for OpenAI, Anthropic, Claude, and others, you send your LLM calls to Keywords AI. And we do the rest rerouting, retries, load-balancing, caching, prompt caching, function calling, image uploading, and fallbacks for you.
...
- [Set up Keywords AI API key](pages/dcoumentation/get-started/setting_up_api_key.mdx)
- [Set up LLM provider API key](pages/dcoumentation/get-started/setting_up_provider_key.mdx)
...
<Card title="OpenAI SDK Integration" href="/pages/integration/development-frameworks/openai-sdk">
</Card>
</Tab>
...
<CardGroup columns={3}>
<Card title="Anthropic" href="/pages/integration/development-frameworks/anthropic">
</Card>
<Card title="LangChain" href="/pages/integration/development-frameworks/langchain">
</Card>
<Card title="Vercel AI SDK" href="/pages/integration/development-frameworks/vercel">
</Card>
<Card title="LlamaIndex" href="/pages/integration/development-frameworks/llama-index">
</Card>
</CardGroup>
</Tab>
</Tabs>
